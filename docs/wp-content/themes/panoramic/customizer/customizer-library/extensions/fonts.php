...
function customizer_library_get_all_fonts() {
	$heading1       = array( 1 => array( 'label' => sprintf( '--- %s ---', __( 'Standard Fonts', 'panoramic' ) ) ) );
	$standard_fonts = customizer_library_get_standard_fonts();
	$heading2       = array( 2 => array( 'label' => sprintf( '--- %s ---', __( 'Google Fonts', 'panoramic' ) ) ) );
...
function customizer_library_get_google_font_subsets() {
	return array(
		'all'          => __( 'All', 'panoramic' ),
		'cyrillic'     => __( 'Cyrillic', 'panoramic' ),
		'cyrillic-ext' => __( 'Cyrillic Extended', 'panoramic' ),
		'devanagari'   => __( 'Devanagari', 'panoramic' ),
		'greek'        => __( 'Greek', 'panoramic' ),
		'greek-ext'    => __( 'Greek Extended', 'panoramic' ),
		'khmer'        => __( 'Khmer', 'panoramic' ),
		'latin'        => __( 'Latin', 'panoramic' ),
		'latin-ext'    => __( 'Latin Extended', 'panoramic' ),
		'vietnamese'   => __( 'Vietnamese', 'panoramic' ),
	);
}
endif;
...
function customizer_library_get_standard_fonts() {
	return array(
		'serif' => array(
			'label' => _x( 'Serif', 'font style', 'panoramic' ),
			'stack' => 'Georgia,Times,"Times New Roman",serif'
		),
		'sans-serif' => array(
			'label' => _x( 'Sans Serif', 'font style', 'panoramic' ),
			'stack' => '"Helvetica Neue",Helvetica,Arial,sans-serif'
		),
		'monospace' => array(
			'label' => _x( 'Monospaced', 'font style', 'panoramic' ),
