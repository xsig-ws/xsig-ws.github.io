...
// Core Constants
define('ELVINAA_REQUIRED_PHP_VERSION', '5.6' );
define('ELVINAA_DIR_PATH', get_template_directory());
define('ELVINAA_DIR_URI', get_template_directory_uri());
define('ELVINAA_THEME_AUTH','https://www.spiraclethemes.com/');
define('ELVINAA_THEME_URL','https://www.spiraclethemes.com/elvinaa-free-wordpress-theme/');
define('ELVINAA_THEME_PRO_URL','https://www.spiraclethemes.com/elvinaa-premium-wordpress-theme/');
define('ELVINAA_THEME_DOC_URL','https://www.spiraclethemes.com/elvinaa-documentation/');
define('ELVINAA_THEME_VIDEOS_URL','https://www.spiraclethemes.com/elvinaa-video-tutorials/');
define('ELVINAA_THEME_SUPPORT_URL','https://wordpress.org/support/theme/elvinaa/');
define('ELVINAA_THEME_RATINGS_URL','https://wordpress.org/support/theme/elvinaa/reviews/#new-post');
define('ELVINAA_THEME_CHANGELOGS_URL','https://themes.trac.wordpress.org/log/elvinaa/');
define('ELVINAA_THEME_CONTACT_URL','https://www.spiraclethemes.com/contact-us/');
...
*
*/
function elvinaa_check_theme_setup( $oldtheme_name, $oldtheme ) {
	// Compare versions.
	if ( version_compare(phpversion(), ELVINAA_REQUIRED_PHP_VERSION, '<') ) :
	// Theme not activated info message.
	add_action( 'admin_notices', 'elvinaa_php_admin_notice' );
	function elvinaa_php_admin_notice() {
		?>
			<div class="update-nag">
		  		<?php esc_html_e( 'You need to update your PHP version to a minimum of 5.6 to run Elvinaa Theme.', 'elvinaa' ); ?> <br />
		  		<?php esc_html_e( 'Actual version is:', 'elvinaa' ) ?> <strong><?php echo phpversion(); ?></strong>, <?php esc_html_e( 'required is', 'elvinaa' ) ?> <strong><?php echo ELVINAA_REQUIRED_PHP_VERSION; ?></strong>
			</div>
		<?php
	}
...
add_action( 'after_switch_theme', 'elvinaa_check_theme_setup', 10, 2  );
...
function elvinaa_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Blog Sidebar', 'elvinaa' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'elvinaa' ),
  ...
  register_sidebar( array(
		'name'          => esc_html__( 'Footer Column1', 'elvinaa' ),
		'id'            => 'footer-column1',
		'description'   => esc_html__( 'Add widgets here.', 'elvinaa' ),
  ...
  register_sidebar( array(
		'name'          => esc_html__( 'Footer Column2', 'elvinaa' ),
		'id'            => 'footer-column2',
		'description'   => esc_html__( 'Add widgets here.', 'elvinaa' ),
		'before_widget' => '<div id="%1$s" class="section %2$s">',
		'after_widget'  => '</div>',
  ...
  register_sidebar( array(
		'name'          => esc_html__( 'Footer Column3', 'elvinaa' ),
		'id'            => 'footer-column3',
		'description'   => esc_html__( 'Add widgets here.', 'elvinaa' ),
		'before_widget' => '<div id="%1$s" class="section %2$s">',
		'after_widget'  => '</div>',
  ...
  register_sidebar( array(
		'name'          => esc_html__( 'Footer Column4', 'elvinaa' ),
		'id'            => 'footer-column4',
		'description'   => esc_html__( 'Add widgets here.', 'elvinaa' ),
		'before_widget' => '<div id="%1$s" class="section %2$s">',
		'after_widget'  => '</div>',
	...
	register_sidebar( array(
		'name'          => esc_html__( 'Top Left Sidebar', 'elvinaa' ),
		'id'            => 'top-left-sidebar',
		'description'   => esc_html__( 'Add widget here.', 'elvinaa' ),
		'before_widget' => '<div id="%1$s" class="section %2$s">',
		'after_widget'  => '</div>',
		'before_title'  => '',
		'after_title'   => '',
