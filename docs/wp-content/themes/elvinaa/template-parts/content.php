    ...
    <div class="blog-wrapper">
        ...
        <div class="title-date">
            <?php
                ...
                {
                    ?><h2><a href="<?php esc_url(the_permalink()) ?>"><?php the_title(); ?></a></h2><?php
                }
            ?>
        ...
        <?php 
            if(!is_single()){
                ?>
                    <div class="read-more">
                        <a href="<?php esc_url(the_permalink()) ?>"><?php echo esc_html(get_theme_mod( 'el_readmore_text',esc_html__('CONTINUE READING...','elvinaa') )); ?></a>
                    </div>
                <?php
            }
        ?>
