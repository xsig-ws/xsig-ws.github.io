			...
			<article id="post-<?php the_ID(); ?>" <?php post_class(); cryout_schema_microdata( 'article' );?>>
				...
				<div class="article-inner">
					...
					<nav id="nav-below" class="navigation" role="navigation">
						<div class="nav-previous"><?php previous_post_link( '%link', '<i class="icon-angle-left"></i> <span>%title</span>', apply_filters( 'fluida_navbelow_sameterm', false ) ); ?></div>
						<div class="nav-next"><?php next_post_link( '%link', '<span>%title</span> <i class="icon-angle-right"></i>', apply_filters( 'fluida_navbelow_sameterm', false ) ); ?></div>
					</nav><!-- #nav-below -->
