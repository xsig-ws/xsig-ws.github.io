...
function cryout_register_addon_plugins() {
	 ...
	 */
	$config = array(
		'id'           => 'fluida',                // Unique ID for hashing notices for multiple instances of TGMPA.
		'default_path' => '',                      // Default absolute path to bundled plugins.
		'menu'         => 'fluida-addons',		   // Menu slug.
		...
		'strings'      => array(
			'page_title'                      => __( 'Fluida Suggested Plugins', 'cryout' ),
			'menu_title'                      => __( 'Fluida Addons', 'cryout' ),
