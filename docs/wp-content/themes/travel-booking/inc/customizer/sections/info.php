...
if ( ! function_exists( 'travel_booking_customizer_theme_info' ) ) :
	...
	function travel_booking_customizer_theme_info( $wp_customize ) {
		...
		$theme_info .= sprintf( '%1$s<a href="%2$s" target="_blank">%3$s</a>', esc_html__( 'Demo Link : ', 'travel-booking' ), esc_url( __( 'https://demo.wptravelengine.com/travel-booking/', 'travel-booking' ) ), esc_html__( 'Click here.', 'travel-booking' ) );
