        ...
        <div class="container">
    		<span class="site-info">
    			<?php
                    ...
                    printf( esc_html__( 'Travel Booking by %1$sWP Travel Engine%2$s.', 'travel-booking' ), '<a href="' . esc_url( 'https://wptravelengine.com/downloads/travel-booking-free-wordpress-theme/' ) .'" rel="nofollow" target="_blank">','</a>' );
